...
#######################################################################
# modify get_MNIST_data to return cubic features
#######################################################################

def pca10(train_x, test_x):
    ...
    return train_pca10, test_pca10

# def cubic(get_MNIST_data):

#     functools.wraps(get_MNIST_data)
#     def wrapper():
#         train_x, train_y, test_x, test_y = get_MNIST_data()
#         train_pca, test_pca = pca10(train_x, test_x)
#         train_cube, test_cube = cubic_features(train_pca), cubic_features(test_pca)
#         return train_cube, train_y, test_cube, test_y

#     return wrapper

# @cubic
# def get_MNIST_data():
#     return utils.get_MNIST_data()
...
# def run_polynomial_svm_on_MNIST():
    
#     train_x, train_y, test_x, test_y = get_MNIST_data()
#     train_x, test_x = pca10(train_x, test_x)
#     pred_test_y = polynomial_svm(train_x, train_y, test_x)
#     test_error = compute_test_error_svm(test_y, pred_test_y)
#     return test_error

# print('Polynomial SVM test_error:', run_polynomial_svm_on_MNIST())

def run_rbf_svm_on_MNIST():
    
    train_x, train_y, test_x, test_y = get_MNIST_data()
    train_x, test_x = pca10(train_x, test_x)
    pred_test_y = rbf_svm(train_x, train_y, test_x)
    test_error = compute_test_error_svm(test_y, pred_test_y)
    return test_error
...
# result = run_softmax_on_MNIST(temp_parameter=1)
# print('softmax test_error=', result[0])
# # print('softmax_original_model mod3_test_error=', result[1])
...
#     """
#     train_x, train_y, test_x, test_y = get_MNIST_data()
#     train_y, test_y = train_y % 3, test_y % 3
#     theta, cost_function_history = softmax_regression(train_x, train_y, temp_parameter, alpha=0.3, lambda_factor=1.0e-4, k=10, num_iterations=150)
#     plot_cost_function_over_time(cost_function_history)
#     test_error = compute_test_error(test_x, test_y, theta, temp_parameter)
#     # Save the model parameters theta obtained from calling softmax_regression to disk.
...
# # print('softmax mod3_test_error', run_softmax_on_MNIST_mod3(temp_parameter=1))
...
# def run_softmax_pca(train_pca, test_pca, temp_parameter=1):
#     """
#     Trains softmax, classifies test data, computes test error, and plots cost function
...
# # print('softmax pca error:', run_softmax_pca(train_pca, test_pca, temp_parameter=1))
...
# # def run_softmax_cubic(temp_parameter=1):
# #     """
# #     Trains softmax, classifies test data, computes test error, and plots cost function
...
# print('cubic softmax error:', run_softmax_on_MNIST(temp_parameter=1))
